...
### *Architecture & Feature Breakdown for MyNetwork Developer Browser*
...
3. **Hover Tooltip**: Displays date and commit count (e.g., *"12 contributions on August 14, 2026"*).
...
## 📝 5. How to Setup a GitHub OAuth App (Step-by-Step)

1. Go to **[GitHub Developer Settings → OAuth Apps](https://github.com/settings/developers)**.
2. Click **New OAuth App**:
   - **Application Name**: `MyNetwork Browser`
   - **Homepage URL**: `https://github.com/TanishkGoswami/MyNetwork-Browser`
   - **Authorization Callback URL**: `http://localhost:8942/oauth/github/callback` *(or `mynetwork://oauth/github`)*
3. Click **Register Application**.
4. Generate a **Client Secret** and copy your **Client ID**.
5. In MyNetwork Browser, open **GitHub Hub Settings** and enter your Client ID.
...
*Document created for MyNetwork Browser Architecture.*
